...
const BuscarTab = {
  template: `
    <div class="glass-card p-4">
      ...
      <!-- Stats -->
      <div v-if="stats" class="row g-2 g-md-3 mb-4 stats-grid">
        ...
        <div class="col-6 col-md-3">
          <div class="glass-card text-center h-100">
            <span class="stat-label"><i class="fa-solid fa-store text-warning me-1"></i>Fontes</span>
            <span class="stat-value text-warning" style="font-size:0.8rem;">{{ fontesList.join(', ') || '--' }}</span>
          </div>
        </div>
      </div>
